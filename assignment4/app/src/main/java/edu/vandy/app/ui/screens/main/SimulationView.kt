...
//        setLayerType(LAYER_TYPE_SOFTWARE, palantiriPaint)
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val resolvedWidth = resolveSizeAndState(
            MeasureSpec.getSize(desiredWidth), widthMeasureSpec, 0
        )
        val resolvedHeight = resolveSizeAndState(
            MeasureSpec.getSize(desiredHeight), heightMeasureSpec, 0
        )
    ...
    class BeingSprite(
        ...
        val prevState get(): State? = snapshot.prevState
