 ...
 */
inline operator fun <reified T> Bundle.get(key: String?, value: T): T? {
    return when (value) {
        ...
        is Parcelable -> getParcelable(key, T::class.java)
        is Serializable -> getSerializable(key, Serializable::class.java)
        else -> {
